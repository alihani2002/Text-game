...
const selectbox = () => {
    ...
    if ( Number(localStorage.level) == 1) {
        ...
        mainNav.style.backgroundImage = "linear-gradient(to left, rgba(127, 249, 149, 0), rgb(121, 121, 121)) ";
    }
    else if ( Number(localStorage.level) == 2) {
    
        myselect.value =2; 
        container.style.backgroundImage = "linear-gradient(to left, rgb(8 227 48 / 0%), rgb(23 217 156))";
        mainNav.style.backgroundImage = "linear-gradient(to left, rgb(8 227 48 / 0%), rgb(23 217 156))";
    }
        ...
        mainNav.style.backgroundImage = "linear-gradient(to left, rgba(127, 249, 149, 0), rgb(208 62 0))";
    }
